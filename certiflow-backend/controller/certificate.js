const certificateEmail = `<html>
        ...
        <body>
            <div id='body' class="center">
                <p class='center'><h3>Hi @@recipientFullName@@ </h3></p>
                <p class='colored'>
                Congratulations, This is your @@degreeType@@ @@degreeName@@ Certificate!
                </p>
                <p>Click here to download!<br></p><br>
                <a href="http://localhost:8082/#/credential/issue/?jwt=@@token@@" target="_blank" style="text-decoration:none;
